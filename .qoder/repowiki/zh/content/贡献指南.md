...
E[".github/workflows/build.yml"] --> F["还原/构建/上传产物"]
G["ExtensionManifest.json"] --> H["插件元数据"]
```

图表来源
- [Windows Utils.csproj:31-48](file://Windows Utils.csproj#L31-L48)
- [Windows Utils.csproj:69-71](file://Windows Utils.csproj#L69-L71)
- [.github/workflows/build.yml:14-34](file://.github/workflows/build.yml#L14-L34)
...
## 结论
本指南提供了从开发环境搭建、代码贡献、翻译贡献到 CI 流程与故障排查的完整路径。遵循本文档可显著提升贡献效率与质量，确保新增功能与翻译内容与现有架构保持一致。
